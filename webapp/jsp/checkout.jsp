				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown"
						...
						<li class="nav-item"><a class="nav-link"
							href="${pageContext.request.contextPath }/AddToCartServlet">Return
								Cart</a></li>
					</ul>
				</div>
			</div>
										...
										<div class="media mb-2 border-bottom">
											<div class="media-body">
												...
												<div class="small text-muted">
													Price: ${product.price}${currency} <span class="mx-2">|</span>
													Quantity: ${product.number} <span class="mx-2">|</span>
													Subtotal: ${product.amount}${currency}
												</div>
											</div>
										</div>
									</div>
						...
						<div class="col-md-12 col-lg-12">
							<div class="order-box">
								<div class="d-flex gr-total">
									<h5>Total</h5>
									<div class="ml-auto h5">${cart.totalAmount}${currency}</div>
								</div>
							</div>
						</div>
					</div>
