					...
					<ul class="nav navbar-nav mr-auto" data-in="fadeInDown"
						...
						<li class="dropdown"><a href="#"
							...
							<ul class="dropdown-menu" style="background-color: white;">
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=yadea&action=getcategory">Yadea</a></li>
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=honda&action=getcategory">Honda</a></li>
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=dk&action=getcategory">DK</a></li>
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=aima&action=getcategory">AIMA</a></li>
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=nijia&action=getcategory">Nijia</a></li>
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=kenko&action=getcategory">Kenko</a></li>
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=forevet&action=getcategory">Forevet</a></li>
								<li><a
									href="${pageContext.request.contextPath }/SearchServlet?name=yamaha&action=getcategory">Yamaha</a></li>
	...
	<div id="carouselExampleIndicators" class="carousel slide"
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img class="d-block w-100" src="../image/baner1.jpg" alt="Banner 1">
			</div>
			<div class="carousel-item">
				<img class="d-block w-100" src="../image/banner2.png" alt="Banner 2">
			</div>
		</div>
								...
								<div class="list-group-collapse sub-men">
									<div class="collapse show" id="sub-men1"
										...
										<div class="list-group">
											<img src="../ads/1.jpg" alt="ads">
										</div>
										<div class="list-group">
											<img src="../ads/2.jpg" alt="ads">
										</div>
										<div class="list-group">
											<img src="../ads/3.jpg" alt="ads">
										</div>
										<div class="list-group">
											<img src="../ads/5.jpg" alt="ads">
										</div>
									</div>
								</div>
							</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-12 col-sm-12">
						<div class="footer-top-box">
							<h3>Contact Us</h3>
							<ul class="list-time">
								<li><i class="fa fa-map-marker"></i> Address: Khu Phố 6, Linh Trung, TP.Thủ Dức, Thành phố Hồ Chí Minh 70000, Việt Nam</li>
