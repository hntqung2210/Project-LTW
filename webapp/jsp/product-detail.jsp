...
<body>
	...
	<!-- Start Shop Detail  -->
	<sql:setDataSource var="ds" driver="com.mysql.cj.jdbc.Driver" url="jdbc:mySQL://localhost:3306/xedap" user="root" password=""/>
			...
			<div class="row">
				...
				<div class="col-xl-8 col-lg-8 col-md-6">
					<div class="single-product-details">
						...
						<h5>
							<c:set var="currency" value="d"></c:set>
							<fmt:formatNumber value="${prod.product_price}" maxFractionDigits="2"
								pattern="#####,##0"></fmt:formatNumber>
								${currency}
						</h5>
						<h4>Description:</h4>
						<p>${prod.product_des}</p><br/>
						<h4>Type:</h4>
						<p>${prod.product_type }</p><br/>
						<h4>Brand:</h4>
						<p>${prod.product_brand}</p><br/>
